...
Scenario Outline: I should not be able to register with invalid data on manadatory field (*) of registration page
...
Scenario: I should be able to select any one radio button from Gender label of Your Personal details section
  ...
  Then   I am able to select aany one of the radio button

Scenario Outline: I should be able to select Day,Month and Year deom drop down list of date of birth field
      ...
      Examples:
          | Day | Month    | Year |
          | 11  | November | 1989 |
Scenario: I should be able to check and uncheck the newslettrt boxon options section
